...
int inputUser, feedingCount = 0, loginLimit = 0;
...
int main() {
  ...
  addSurvivor(survivorList, &bunker, "Budi", "Male", "01", "01", "2000");
  addSurvivor(survivorList, &bunker, "Radi", "Male", "01", "01", "2000");
  addSurvivor(survivorList, &bunker, "Gea", "Female", "01", "01", "2000");
